...
elimina.addEventListener('click', (e) => {
    ...
    if(!(nameProduct.value && description.value && brand.value && imageUrl.value && price.value)){
    ...
    .then(product => {
        ...
        imageUrl.value = product.imageUrl;
            ...
            create.addEventListener('click', () => {
                ...
                if (!urlRegex.test(imageUrl.value)) {
                    return Swal.fire(`Inserisci un URL valido per l'immagine! I formati accettati sono "JPG" "GIF" e "PNG"`);
                }
                    ...
                    if (result.isConfirmed) {
                        ...
                        updateProduct(url, id, productUpdate)
                            ...
                            .catch(error => {
                                ...
                                Swal.fire("Si è verificato un errore durante l'aggiornamento del prodotto");
                            });
                    } else if (result.isDenied) {
