...
let risultato2 = numero1 < numero2
...
if (totalShoppingCart>50){
  console.log( `Congratulazione, Hai diritto alla spedizione gratuita! 
  Il totale ammonta a ${totalShoppingCart}`)
}else{
  console.log( `La spedizione costa 10 , il totale ammonta a ${totalShoppingCart + 10}`)
}
...

{
 ...
 let totalShoppingCartSconto= totalShoppingCart - sconto

  if (totalShoppingCartSconto>50){
    console.log( `Congratulazione, Hai diritto alla spedizione gratuita! 
    Il totale ammonta a ${totalShoppingCartSconto}`)
  }else{
    console.log( `La spedizione costa 10 , il totale ammonta a ${totalShoppingCart + 10}`)
  }
